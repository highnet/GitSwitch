...
- "Match to active" sets your global git commit identity (`user.name` /
  `user.email`) from the active account, pulling the email from the GitHub API
  (falling back to the `users.noreply.github.com` privacy address)
